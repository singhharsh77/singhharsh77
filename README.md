...
<h3 align="center">Wroking as a Jr. DevOps in Gurugram, Haryana | AWS Certified Solutions Architect – Associate | AI | Cloud | Building Scalable Systems & FullStack Intelligent Workflows</h3>
...
<div align="center">
  ...
  <a href="[https://www.linkedin.com/in/YOUR-LINKEDIN](https://www.linkedin.com/in/harsh-singh-7813322488
)">
...
- 🎓 **4th Year BTech. CSE** student (2026).
- 🔒 Passionate about **AI-Native Full-Stack Development, Cloud-DevOps, SRE**.   
...
| **EC-Council** | Digital Forensics Essentials (DFE) | Learned investigation and forensic techniques | Digital Forensics, Incident Response | [View](https://learn.eccouncil.org/certificate/dbf2a9c0-6dfa-4fbe-8f38-b912d8ea6616?logged=false) |
| **EC-Council** | Network Defense Essentials (NDE) | Explored network defense strategies and tools | Firewalls, IDS/IPS, Network Security | [View](https://learn.eccouncil.org/certificate/326de312-626f-4c61-ad7b-7959fe041e7e?logged=false) |
| **EC-Council** | Android Bug Bounty Hunting: Hunt Like a Rat | Specialized training on mobile app security testing | Android Security, Vulnerability Analysis | [View](https://learn.eccouncil.org/certificate/e0d7c88c-619f-4199-a0d4-211871405f70?logged=false) |
| **EC-Council** | SQL Injection Attacks | Practical exposure to SQL injection attack vectors | Database Security, Exploitation | [View](https://learn.eccouncil.org/certificate/163a270b-1b41-4194-bedf-29ce99f9bbb9?logged=false) |
| **Coursera** | Preparing for Professional Cloud Security Engineer Journey | Covered foundations of securing workloads in Google Cloud | Cloud Security, IAM, GCP | [View](https://www.coursera.org/account/accomplishments/verify/DKU747SECDKD?utm_source=ln&utm_medium=certificate&utm_content=cert_image&utm_campaign=pdf_header_button&utm_product=course) |
| **Coursera** | Hands-on Introduction to Linux Commands & Shell Scripting | Practical Linux scripting and automation skills | Linux, Shell Scripting, Automation | [View](https://www.coursera.org/account/accomplishments/verify/VCFNL4LR5YNZ?utm_source=ln&utm_medium=certificate&utm_content=cert_image&utm_campaign=pdf_header_button&utm_product=course) |
| **Coursera** | Exploiting and Securing Vulnerabilities in Java Applications | Advanced techniques for finding and mitigating Java vulnerabilities | Java Security, Secure Coding, Vulnerability Management | [View](https://www.coursera.org/account/accomplishments/verify/PCVLE4BE5QX9?utm_source=ln&utm_medium=certificate&utm_content=cert_image&utm_campaign=pdf_header_button&utm_product=course) |
| **Coursera** | Introduction to Cybersecurity Tools & Cyberattacks | Learned tools, techniques, and basics of cyberattacks | Cybersecurity Tools, Threat Analysis | [View](https://www.coursera.org/account/accomplishments/verify/X08VXE6ARXJO?utm_source=ln&utm_medium=certificate&utm_content=cert_image&utm_campaign=sharing_cta&utm_product=course) |
...
|--------------|-------------|--------|-------|
| **TaskFlow — Team Task Manager** | Full-stack **SaaS collaboration platform** with role-based auth (Team Lead/Member), project & task management, audit logs, dashboard analytics, and Railway deployment using React, Node.js, Express, MongoDB, and JWT. | 🌐 Live | [GitHub](https://github.com/singhharsh77/Team-Task-Manager-Full-Stack-) · [Live Demo](https://team-task-manager-production-9c55.up.railway.app/) |
| **CloudOps AI Assistant (RAG DevOps Chatbot)** | DevOps-focused **RAG chatbot** using FAISS + Llama-3 + Groq for AWS/Kubernetes troubleshooting, structured debugging, and Dockerized deployment. | 🌐 Live | [GitHub](https://github.com/singhharsh77/cloudops-ai-assistant) · [Live Demo](https://cloudops-ai-assistant-q4pnhpbgdyywtqmpv6pkbh.streamlit.app/) |
| **AWS Cost Predictor** | Serverless **MLOps + FinOps pipeline** with Terraform, AWS Lambda, S3, SNS, and Python for forecasting cloud billing trends, spend optimization, and proactive cost alerts. | ✅ Completed | [GitHub](https://github.com/singhharsh77/aws-cost-ai_optimizer) |
| **Kali Linux NAS Server** | Secure NAS with **Samba**, SSH, user authentication, logging automation, and access control for collaborative file sharing. | ✅ Completed | [LinkedIn](https://www.linkedin.com/posts/harsh-singh-781332248_nas-cybersecurity-samba-activity-7291098275770732545-kVLw?utm_source=share&utm_medium=member_desktop&rcm=ACoAAD1F6NEBOMyXbCRVnSsDcetYIRlvBYk7hXw) · [GitHub](https://github.com/singhharsh77/NAS_Server) |
| **Smart File Compressor (Huffman Algorithm)** | Full-stack **file compression system** using Huffman Encoding with React frontend, Node.js APIs, and Java backend for optimized file size reduction. | ✅ Completed | [GitHub](https://github.com/singhharsh77/file-compressor) |
| **AMUL_CronJob** | Python automation with **GitHub Actions** to monitor AMUL milk stock by PIN code and send Gmail notifications. | ✅ Completed | [LinkedIn](https://www.linkedin.com/posts/harsh-singh-781332248_githubactions-automation-python-activity-7365087413867642880-agTm?utm_source=share&utm_medium=member_desktop&rcm=ACoAAD1F6NEBOMyXbCRVnSsDcetYIRlvBYk7hXw) · [GitHub](https://github.com/singhharsh77/AMUL_CronJob) |
| **DevSecOps Honeypot (Cowrie SSH)** | Raspberry Pi-based **threat observability pipeline** with Cowrie, ELK Stack, and Grafana for attacker behavior analysis and SIEM-style dashboards. | ✅ Completed | [LinkedIn](https://www.linkedin.com/posts/harsh-singh-781332248_cybersecurity-devsecops-honeypot-activity-7303419778797293568--XQm?utm_source=share&utm_medium=member_desktop&rcm=ACoAAD1F6NEBOMyXbCRVnSsDcetYIRlvBYk7hXw) · [GitHub](https://github.com/singhharsh77/Honeypot) |
| **Phishing Attack Workshop** | Conducted a **hands-on phishing awareness workshop** covering attack vectors, social engineering, Kali Linux demos, and defense strategies. | ✅ Completed | [LinkedIn](https://www.linkedin.com/posts/harsh-singh-781332248_phishingattacks-cybersecurityawareness-handsontraining-activity-7164324770501550083-8oto?utm_source=share&utm_medium=member_desktop&rcm=ACoAAD1F6NEBOMyXbCRVnSsDcetYIRlvBYk7hXw) |
| **Kali Linux Style Portfolio** | Terminal-themed **React portfolio website** inspired by Kali Linux aesthetics, deployed on Vercel. | 🌐 Live | [Live Portfolio](https://terminal-singh-harsh-com.vercel.app/) · [LinkedIn](https://www.linkedin.com/posts/harsh-singh-781332248_terminalportfolio-reactjs-cybersecurity-activity-7353489087078543360-3YX4?utm_source=share&utm_medium=member_desktop&rcm=ACoAAD1F6NEBOMyXbCRVnSsDcetYIRlvBYk7hXw) |
| **College SaaS App Prototype** | Early-stage **cloud-based student food ordering platform** focused on campus convenience and workflow automation. | 🛠 Ideation Phase | — |
